    ...
    */
    ...
    for (let prop in func.prototype) {
        ...
        switch (typeof value) {
            ...
            case "function":
                code += `${_name}.prototype.${prop} = function(){debugger}; vmcore.func_set_native(${_name}.prototype.${prop});\n`;
                break
    ...
    */
    ...
    for (let prop of  propList) {
        ...
        switch (typeof value) {
            //function时，value.toString();
            case "function":
                code += `${_name}.${prop} = function(){debugger}; vmcore.func_set_native(${_name}.prototype.${prop});\n`;
                break
            //object时，value.toString();
            case "object":
