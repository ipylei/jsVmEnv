        ...
        return function (_ace_4752e, _ace_aa949, _ace_be07c) {
            ...
            var _ace_8cba0 = function (_ace_0a916) {
                ...
                if (_ace_0a916._ace_38c9c) {
                    if (_ace_0a916._ace_47589.indexOf && _ace_0a916._ace_47589.indexOf("getAttribute") > -1) {
                        debugger;
                        return getAttribute;
                    }else{
            ...
            var _ace_aec23 = [function (p0, p1, p2, p3, p4, p5, p6) {
                ...
                , function (p0, p1, p2, p3, p4, p5, p6) {
                    ...
                    if (_ace_8712.toString().indexOf("getAttribute") > 0) {
                        var tmp = null;
                        debugger;
                    } else {
                        var tmp = _ace_8712.apply(typeof _ace_25a6._ace_936 == "undefined" ? _ace_4752e : _ace_25a6._ace_936, _ace_bdcc);
                    }
                    _ace_1ae3c(tmp, _ace_be07c, _ace_be07c, 0);
                    return ++p4;
                }
                , function (p0, p1, p2, p3, p4, p5, p6) {
